namespace NOption.Tests
{
    ...
    public class OptTableTest
    {
        ...
        [Fact]
        public void CtorRequiresNonNullOptions()
        {
            Assert.Throws<ArgumentNullException>(() => new OptTable(null));
        }
        ...
        public void RejectsDuplicateOptionId()
        {
            ...
            Assert.Throws<InvalidOptTableException>(() => new OptTable(options));
        }
