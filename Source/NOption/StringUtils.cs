namespace NOption
{
    ...
    internal static class StringUtils
    {
        ...
        public static int CompareNameCase(string left, string right)
        {
            return CompareLongest(left, right, StringComparison.Ordinal);
        }

        public static int CompareNameIgnoreCase(string left, string right)
        {
            return CompareLongest(left, right, StringComparison.OrdinalIgnoreCase);
        }
    }
}
